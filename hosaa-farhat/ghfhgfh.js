...
(function(md) {
    ...
    md(function() {
      ...
      if(!("dihak"==secretBlog&&window.location.href.indexOf(urlBlog)>-1)&&notload){
      	md('<div class="ads" style="margin-bottom: 20px;border-radius: 5px;overflow: hidden;box-shadow: 0 3px 1px rgba(0,0,0,0.16),0 3px 6px rgba(0,0,0,0.23);display: inherit;height: 250px;"><a href="https://www.th3farhat.com/" target="_blank" title="Tutorial Blogger | th3farhat"><img alt="th3farhat" src="https://3.bp.blogspot.com/-JfDBeYWkELw/W0KiY0-ZzkI/AAAAAAAAE5U/YlKuyEyA9cEn3Rh-Xz5ALKnAPJJpSWkzgCLcBGAs/s1600/iklan-shannenpio.png"></a><span class="iklan-th3farhat" style="display: none;background:#d3d3d3;width:100px;height:15px;border-bottom-left-radius:4px;position:absolute;top:0;right:0;color:#000;font:normal 11px Arial,Sans-Serif;text-align:left;overflow:hidden;padding-right:19px;display: none;">Iklan oleh th3farhat</span><span class="info-icon" style="width:15px;height:15px;position:absolute;top:0;right:0;cursor:pointer"><a href="https://www.th3farhat.com/" target="_blank"><img alt="info" src="http://2.bp.blogspot.com/--ivaHIgXThk/UnJWU80FLhI/AAAAAAAAF_Y/WrH-8aYijGw/s1600/iklan-shannenpio.png" style="vertical-align: top;"></a></span></div>').insertBefore('#sidebar-atas');
